...
const generateToc = function ({
  ...
  if (relativePath.startsWith("docs.phpcomposer.com")) {
    ...
    !relativePath.startsWith("getcomposer.org/apidoc/master/Composer")
  ) {
    if (
...
module.exports = {
  ...
  platformFamily: "Composer",
  entry: "docs.phpcomposer.com/index.html",
  domain: ["docs.phpcomposer.com", "getcomposer.org/apidoc/master"],
  include: [],
  exclude: [],
  generator: [
    {
